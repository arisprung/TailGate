...
public class TailGateMessagesContentProvider extends ContentProvider
{
	...
	private static final int STATS = 10;
	private static final int STATS_ID = 20;
	...
	static
	{
		sURIMatcher.addURI(AUTHORITY, BASE_PATH, STATS);
		sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", STATS_ID);
	}
